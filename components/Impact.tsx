                ...
                <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
                    ...
                    <div className="bg-white shadow-xl rounded-2xl sm:rounded-3xl overflow-hidden w-full sm:w-1/2">
                     <div className="p-4 text-center">
                        ...
                        <div className="relative aspect-4/3 w-full">
                            <Image
                                src="https://images.unsplash.com/photo-1565353919366-554312dd0e86?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0"
                                alt="Dog Before Care"
                                fill
                    ...
                    <div className="bg-white shadow-xl rounded-2xl sm:rounded-3xl overflow-hidden w-full sm:w-1/2">
                      <div className="p-4 text-center">
                        ...
                        <div className="relative aspect-4/3 w-full">
                            <Image
                                src="https://images.unsplash.com/photo-1553674418-95c3688078c6?q=80&w=704&auto=format&fit=crop&ixlib=rb-4.1.0"
                                alt="Dog After Care"
                                fill
                                className="object-cover"
                            />
                    ...
                    <div className="mx-auto  flex flex-col items-center">
                        <h2 className="text-xl sm:text-2xl font-medium text-center font-metro">
                            Buddy's Journey
                        </h2>
